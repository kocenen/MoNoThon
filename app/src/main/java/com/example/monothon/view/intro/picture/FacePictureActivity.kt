    ...
    private fun checkUserFace(faceInfo: Face, imageFile: File) {
        if(faceInfo.emotion.confidence >= 0.5) {
            ...
            when(faceInfo.emotion.value) {
                "angry" -> startActivity(Intent(this, SunBreakActivity::class.java).apply { putExtra("imageFile", imageFile) })
                "disgust" -> startActivity(Intent(this, SunBreakActivity::class.java).apply { putExtra("imageFile", imageFile) })
                "fear" -> startActivity(Intent(this, SunBreakActivity::class.java).apply { putExtra("imageFile", imageFile) })
                "sad" -> startActivity(Intent(this, SunBreakActivity::class.java).apply { putExtra("imageFile", imageFile) })
                else -> {
